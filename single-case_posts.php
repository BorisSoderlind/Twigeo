					...
					<div class="row white-container">
						...
						<main id="main" role="main">
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class('cf'); ?> role="article">
								...
								<header class="article-header col-md-8">
							...
							<section class="col-md-3 col-md-offset-1 news">
							    ...
							    foreach ($case as $thecase)
							    {
							    	// Since we're doing this outside the loop,
							        // Build the apply the filters to the post's content
							    	$content = $thecase->post_content;
							        $content = str_replace(']]>', ']]&gt;', $content);
							        $content = apply_filters('the_content', $content);
							        $post_type = get_permalink( $thecase->ID );

							        echo '<a href="' . get_permalink( $thecase->ID ) . '">';
							    	echo '<li>' . $thecase->post_title . '</li>';
							    	echo '</a>';
